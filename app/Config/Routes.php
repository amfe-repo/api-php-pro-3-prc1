...
$routes->get('api/categories/search/(:num)', 'API\Entities::search/$1');
...
$routes->get('api/jobsposted/search/(:num)', 'API\Entities::search/$1');
...
$routes->get('api/schedulejob/search/(:num)', 'API\Entities::search/$1');
...
$routes->get('api/bussiness/search/(:num)', 'API\Entities::search/$1');
